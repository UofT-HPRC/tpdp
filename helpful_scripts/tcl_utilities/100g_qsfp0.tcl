...
endgroup
startgroup
create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf:2.1 QSFP0/util_ds_buf_0
endgroup
connect_bd_net [get_bd_pins QSFP0/cmac_usplus_0/init_clk] [get_bd_pins QSFP0/util_ds_buf_0/IBUF_OUT]
startgroup
create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 QSFP0/init_clk
connect_bd_intf_net [get_bd_intf_pins QSFP0/init_clk] [get_bd_intf_pins QSFP0/util_ds_buf_0/CLK_IN_D]
endgroup
startgroup
