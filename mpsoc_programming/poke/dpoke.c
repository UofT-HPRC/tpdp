...
char *usage = 
"Usage: mpsoc_poke 0xADDR [DATA]\n"
"\n"
"Accesses memory at address 0xADDR. If DATA (base 10) is given," 
"a 32-bit write is performed. Otherwise, a 32 bit read is performed\n";
