//NOTE: this is a register interface I made for one of my own projects. At some
//point I'll come back and make it match the diagram in the text file

#include "ap_int.h"

void axilite_reg_intf (
